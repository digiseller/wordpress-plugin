...
function digiseller_shortcode( $atts )
{
    ...
    $id = $atts['id'];
    $op = (isset($atts['op'])) ? $atts['op'] : 'logo,search,cart,purchases,lang,cath,menu,widen';
...
function digiseller_content( $content ) {
    ...
    if ( !empty($pageid) and !empty($sellerid) and is_page( $pageid ) ) {
        $options = array(
            ...
            'widen' => get_option( 'digiseller_setting_widen', 'off' ) == 'on',
        );
...
function digiseller_settings_page() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <div class="info">
                * <?php echo __("Only your products can be added into cart (not partners' products)", 'digiseller'); ?>
            </div>
            <div class="info">
                ** <?php echo __('Menu items can be configured in', 'digiseller'); ?>
                <a href="https://my.digiseller.ru/inside/myshop.asp?view=settings"><?php echo __('settings', 'digiseller'); ?></a>
            </div>
            <div class="info">
                *** <?php echo __('Overwrites some default styles of wordpress theme', 'digiseller'); ?>
            </div>
...
function digiseller_settings() {
    ...
    add_settings_field(
        'digiseller_setting_widen', __('Output to full page width', 'digiseller') . ' ***',
        'digiseller_setting_widen_callback', 'digiseller_settings', 'digiseller_setting_section'
    );
    ...
    register_setting( 'digiseller_settings', 'digiseller_setting_widen' );
}
...
function digiseller_setting_widen_callback() { digiseller_setting_checkbox_callback( 'digiseller_setting_widen' ); }
